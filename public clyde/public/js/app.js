...
class App{
	...
	coffeeSearch(){
		...
		for(let i=0;i<c.length;i++){
			let expr1 = (c[i].flavor.toUpperCase().indexOf(value.toUpperCase()) > -1);
			if(expr1){
				html += `				
					<li class="collection-item avatar">
						<i class="material-icons circle red">play_arrow</i>
						<span class="title">${this.coffee[i].flavor}</span>
						<p>
							${this.coffee[i].price}
						</p>
		...
		this.reRender(html,document.getElementById("searchPageList"));
	}
	...
	musicSearch(){
		...
		for(let i=0;i<m.length;i++){
			let expr1 = (m[i].title.toUpperCase().indexOf(value.toUpperCase()) > -1);
			if(expr1){
				html += `				
					<li class="collection-item avatar">
						<i class="material-icons circle red">play_arrow</i>
						<span class="title">${this.music[i].title}</span>
						<p>
							${this.music[i].genre}
						</p>
						<a onclick="component.updateMusic(${this.music[i].id})" href="#!" class="secondary-content"><i class="material-icons">mode_edit</i></a>
					</li>				
				`;	
			}			
		}
		...
		this.reRender(html,document.getElementById("searchPageMusicList"));
	}
...
class Component extends App{
	...
	landingPage(){
		let html = `
			...
			<a onclick="component.landingPage()" class="waves-effect waves-light btn">Home</a>
			<a onclick="component.searchPage()" class="waves-effect waves-light btn">Search</a>
	...
	searchPage(){
				...
				<div class="nav-wrapper">
					<form>
						<div class="input-field">
							<input onkeyup="component.coffeeSearch()" id="search" type="search" required>
		...
		`;
		this.reRender(html,document.getElementById("searchPage"));
		...
		let html = `
			...
			<nav>
				<div class="nav-wrapper">
					<form>
						<div class="input-field">
							<input onkeyup="component.musicSearch()" id="search" type="search" required>
							<label for="search"><i class="material-icons">search</i></label>
							<i class="material-icons">close</i>
						</div>
					</form>
				...
				<div id="searchPageMusicList"></div>
			`;
		...
		let html = `
			<div class="row">
				<div class="input-field col s6">
					<input id="musicTitle" type="text" class="validate" value="${this.music[id].title}">					
				</div>
				<div class="input-field col s6">
					<input id="musicGenre" type="text" class="validate" value="${this.music[id].genre}">
				</div>
			</div>
			<a onclick="component.updateMusicNow(${id})" class="waves-effect blue waves-light btn">Update</a>
			<hr/>
		`;	
		this.reRender(html,document.getElementById("updateMusic"));		
	}
}
	...
	recipeLayout(){
		let html = `
			<div id="recipeLayout" class="container">
				<nav>
					<div class="nav-wrapper">
						<a href="#" onclick="component.recipeLayout()" class="brand-logo">&nbsp;&nbsp;SUD-AN v1.0</a>
